...
int main() {
    ...
    Phase phase2("Phase 2", {R, R_PRIME, R2, L, L_PRIME, L2, F, F_PRIME, F2, B, B_PRIME, B2, U, U_PRIME, U2, D, D_PRIME, D2, r, r_PRIME, r2, l, l_PRIME, l2, f2, b2, u2, d2}, {5,6,9,10,21,22,25,26,37,38,41,42,53,54,57,58,69,70,73,74,85,86,89,90}, {{-3, {5,6,9,10,85,86,89,90}}, {-4, {37,38,41,42,69,70,73,74}}}, "phase2table.bin");
