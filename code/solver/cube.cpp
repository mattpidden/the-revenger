...
Cube4x4 phase3_cube;
Phase phase3("Phase 3", phase3_moves, phase3_is_solved, phase3_mask, "phase3table.bin", -1, 8);
...
Cube4x4 phase4_cube;
Phase phase4("Phase 4", phase4_moves, phase4_is_solved, phase4_mask, "phase4table.bin", -1, 8);
